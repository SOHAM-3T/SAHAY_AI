...
def parse_resume(raw_text: str) -> dict:
    ...
    projects = extract_section(raw_lines, "project") or extract_section(
        raw_lines, "projects"
    )
    skill_lines = extract_section(raw_lines, "skills") or extract_section(
        raw_lines, "technical skills"
    )
